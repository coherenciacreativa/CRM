...
| `welcome-audio-send-boundary` | `integrated_ready_for_next_approval` | Welcome audio consultant | `codex/crm-core-welcome-audio` | `docs/crm-vnext/workstreams/welcome-audio-send-boundary.md` | Audio asset registry, already-welcomed history, send approval packet, duplicate prevention. No send authorized. | `docs/crm-vnext/welcome-audio-*.md`; `docs/crm-vnext/instagram-welcome-audio-*.md`; lane status file | central files unless approved; private artifacts; source state | `b3a72bf2b75f76910f062f90d9092f9a7e44d4da` | none | first lane artifact review | choose next welcome-audio lane design step, likely audio asset registry / already-welcomed history packet design, without send | integrated |
