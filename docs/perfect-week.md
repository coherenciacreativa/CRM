...
PERFECT_WEEK_TRIGGER_GROUP_ID=153400728188094209
...
Notas:
- `PERFECT_WEEK_TRIGGER_GROUP_ID` tiene default `153400728188094209` (grupo disparador base).
- `PERFECT_WEEK_ONBOARDING_GROUP_ID` define el grupo de arranque del correo (recomendado `154049618670257330`).
